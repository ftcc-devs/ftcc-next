  ...
  return (
    <div className='flex flex-col justify-start md:justify-center items-center w-full bg-transparent z-20'>
      <div className='flex flex-col justify-start items:start md:items-center py-4 md:py-8 w-full max-w-screen-xl'>
        ...
        <h1 className='text-4xl md:text-5xl xl:text-6xl text-left md:text-center font-bold w-4/5 lg:w-3/5 mt-6 md:mt-10 mb-4 md:mb-8 tracking-tight'>Empowering Filipino IT professionals in Canberra</h1>
        ...
        <div className="flex flex-col md:flex-row justify-center items-start md:items-center gap-4 my-8 md:my-12 w-full">
          <a href="#about" className='text-sm font-semibold uppercase w-full md:w-fit px-4 md:px-8 py-4 bg-indigo-700 hover:bg-indigo-900 border-2 border-indigo-700 hover:border-indigo-900 hover:shadow-glow text-indigo-100 hover:text-white rounded-lg tracking-wider transition duration-300'>Get to know us</a>
          <a href="#membership" className='text-sm font-semibold uppercase w-full md:w-fit px-4 md:px-8 py-4 bg-transparent hover:shadow-glow border-2 border-indigo-700 text-indigo-700 rounded-lg tracking-wider transition duration-300'>Become a member</a>
        </div>
