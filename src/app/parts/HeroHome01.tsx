      ...
      <div id='hero01' className='flex flex-col justify-start md:justify-center items-center w-full bg-transparent z-10 px-6 lg:px-12 pt-28 lg:pt-40 pb-8 lg:pb-20'>
        <div className='flex flex-col justify-start items:start md:items-center py-4 md:py-8 w-full max-w-screen-xl'>
          ...
          <div className="flex flex-col md:flex-row justify-center items-start md:items-center gap-4 my-8 md:my-12 w-full">
            <a href="#about" className='font-heading text-sm font-semibold uppercase w-full md:w-fit px-4 md:px-8 py-4 bg-indigo-500 hover:bg-indigo-700 border border-indigo-500 hover:border-indigo-700 text-white rounded-lg tracking-wider hover:-translate-y-1 transition duration-300'>Get to know us</a>
            <a href="#join" className='font-heading text-sm font-semibold uppercase w-full md:w-fit px-4 md:px-8 py-4 bg-transparent hover:bg-indigo-700 border border-indigo-700 text-white rounded-lg tracking-wider hover:-translate-y-1 transition duration-300'>Join our community</a>
          </div>
