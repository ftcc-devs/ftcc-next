...
function HeroHome01() {
  return (
    <div id='hero01' className='flex flex-col justify-start md:justify-center items-center w-full bg-transparent z-10 px-6 lg:px-12 pt-4 pb-8 lg:pt-20 lg:pb-18'>
