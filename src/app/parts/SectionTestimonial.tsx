...
function SectionTestimonial() {
  ...
  return (
    <div id="testimonials" className='flex flex-row justify-start md:justify-center items-center w-full px-6 my-20 bg-gradient-to-br from-indigo-950 from-60% via-indigo-900 via-80% to-indigo-500 text-slate-100 relative'>
