...
function Footer() {
  return (
    <div className='flex flex-col justify-start md:justify-start items-center w-full pt-24 md:pt-36 pb-12 md:pb-20 px-6 bg-indigo-950 mt-40 text-slate-200'>
      <div className="w-full flex flex-col items-center max-w-screen-lg">

        <div id="footer-quote" className='text-center w-4/5 md:w-3/5 mb-16 md:mb-32'>
          <p className='text-2xl italic tracking-tight'>“I am pleased that the growing tech community in Canberra decided to come together and strengthen our credentials as highly competent tech workers and movers.”</p>
          <p className='uppercase text-sky-200 mt-8 text-sm tracking-wide'>Ambassador Ma. Hellen B. De La Vega</p>
        </div>

        <div id="footer-menu-row" className='grid grid-cols-2 md:grid-cols-6 gap-4 lg:gap-8'>
        ...
        <div id="copyright" className='flex flex-col lg:flex-row w-full justify-between items-start lg:items-center py-4 my-16 border-t-2 border-dotted border-slate-700 text-slate-400'>
