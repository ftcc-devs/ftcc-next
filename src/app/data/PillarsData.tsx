const pillars : Pillar[] = [
  {
    ...
    blurb: 'Our primary purpose is to help members grow their careers',
    description:'',
  },
  {
    id: '2',
    ...
    blurb: 'Providing a warm and positive space to grow is essential',
    description:'',
  },
  {
    id: '3',
    ...
    title: 'Socials',
    blurb: 'A good balance of career, personal and social life can be achieved',
    description:'',
  },
  {
    id: '4',
    ...
    blurb: 'In addition to benefits, members are encouraged to give back and share',
    description:'',
  },
  {
    id: '5',
    ...
    title: 'Mentoring',
    blurb: 'Members helping members is such a positive experience within the community',
    description:'',
  },
  {
    id: '6',
    ...
    blurb: 'Inspiring and challenging each other through collaborative competitions can be fun!',
    description:'',
  },
]
