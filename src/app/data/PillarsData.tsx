const pillars : Pillar[] = [
  {
    ...
    blurb: 'You can break the mold and take that first step to reach those sectors',
    description:'',
  },
  {
    id: '2',
  ...
  {
    id: '5',
    icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 stroke-indigo-700 mb-2">
